...
//       provider : 'google',
//       options: {
//       redirectTo: `${window.location.origin}/dashboard`, // 👈 force redirect
//     },
//     })
//     if(error){
...
//               <Button className="w-full mt-6 bg-violet-500 hover:bg-violet-600 text-white rounded-xl flex gap-2 items-center justify-center" onClick = {signinWithGoogle}>
